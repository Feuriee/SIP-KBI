                    ...
                    <div class="p-6">
                        ...
                        <form id="pakan-form" class="space-y-4">
                            ...
                            <div>
                                ...
                                <input type="text" id="nama_pakan" required
                            ...
                            <div>
                                ...
                                <input type="text" id="jenis_pakan" required
                                    class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 focus:ring-2 focus:ring-sipkbi-green focus:border-transparent">
                            </div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div>
                                    ...
                                    <input type="number" step="0.01" id="stok_kg" required
                                        class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 focus:ring-2 focus:ring-sipkbi-green focus:border-transparent">
                                </div>
                            </div>
        ...
        <script>
            ...
            async function loadPakan(search = '', hargaFilter = '', stokFilter = '') {
                try {
                    ...
                    if (hargaFilter === 'tertinggi') {
                        params.append('sort_by', 'harga_per_kg');
                        params.append('sort_order', 'desc');
                    } else if (hargaFilter === 'terendah') {
                        params.append('sort_by', 'harga_per_kg');
