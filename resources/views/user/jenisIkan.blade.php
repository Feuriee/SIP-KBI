...
<head>
    ...
    <title>Dashboard | Jenis Ikan</title>
...
<body class="bg-gray-50 dark:bg-gray-900 text-gray-900 dark:text-gray-100 transition duration-500">
                ...
                <div class="p-6">
                    ...
                    <form id="ikan-form" class="space-y-4" novalidate>
                        ...
                        <div>
                            ...
                            <input type="text" id="nama_ikan" required
    ...
    <script>
        ...
        // Load data jenis ikan dengan filter dan search
