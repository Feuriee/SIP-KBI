...
<body class="bg-gray-50 dark:bg-gray-900 text-gray-900 dark:text-gray-100 transition duration-500">
                    ...
                    <form id="pegawai-form" class="space-y-4">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <input type="number" step="0.01" id="gaji_pokok" required
                                    class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 focus:ring-2 focus:ring-sipkbi-green focus:border-transparent">
                            </div>
                        </div>
    ...
    <script>
        ...
        async function loadPegawai(search = '', gaji = '') {
            try {
                const params = new URLSearchParams();

                // Search parameter (nama atau jabatan)
                ...
                const url = `/api/pegawai${queryString ? '?' + queryString : ''}`;
        ...
        // Event listener untuk filter dropdown (auto filter)
